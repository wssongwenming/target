                ...
                <ul class="submenu">
                        ...
                        <ul class="submenu">
                            ...
                            <li class="">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="">
                                        <a class="popstyle" href="/sys/trainee/group.page" target="_blank">
                                            <i class="menu-icon fa fa-caret-right"></i>
                                            参训人员进行分组
                                        </a>
                                        <b class="arrow"></b>
                                    ...
                                    <li class="">
                                        <a class="popstyle" href="/sys/trainee/traineegroupquery.page" target="_blank">
                                            <i class="menu-icon fa fa-caret-right"></i>
                                            参训人员分组情况
                                        </a>
                                        <b class="arrow"></b>
                    ...
                    <li class="">
                        ...
                        <ul class="submenu">
                            ...
                            <%--<li class="">
                        <a class="popstyle" href="/rabbitmq/initcamera?json=initcamera">
                            <i class="menu-icon fa fa-caret-right"></i>
                            初始化拍照终端
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="">
                        <a class="popstyle" href="/rabbitmq/senddata1" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            发送测试数据1
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="">
                        <a class="popstyle" href="/sys/websocket/websocket.loginpage" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            websocket测试
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="">
                        <a class="popstyle" href="/sys/menu/menutry.page" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            右键菜单测试
                        </a>
                        <b class="arrow"></b>
